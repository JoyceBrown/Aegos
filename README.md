...
- `RELEASE_3.6.51.md`: current candidate release notes, verification, installer hash, and known limits.
...
```text
src-tauri/target/release/bundle/nsis/Aegos_3.6.51_x64-setup.exe
```
...
The 3.6.51 candidate baseline includes 183 Rust tests, an 89-node complete-list interaction fixture, and an 8,000-node virtual-list and streamed-speed pressure fixture.
