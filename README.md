...
- `RELEASE_3.6.35.md`: current release notes, verification, installer hash, and known limits.
...
The 3.6.35 verification baseline includes 158 Rust tests, an 89-node complete-list interaction fixture, and an 8,000-node virtual-list and streamed-speed pressure fixture.
