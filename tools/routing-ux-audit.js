...
check('system rules are separated into a user-readable summary', appJs.includes('function splitRoutingRules') && appJs.includes('function routingSystemRuleBuckets') && appJs.includes('routingSummaryDetail') && stylesCss.includes('.routing-summary-detail'), 'system rule summary');
