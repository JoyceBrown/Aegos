...
check('settings save rejects proxy port conflicts', mainRs.includes('fn validate_port_settings_snapshot') && mainRs.includes('core_runtime::RESERVED_MIXED_PORTS.contains(&settings.mixed_port)') && coreRuntimeRs.includes('pub const RESERVED_MIXED_PORTS') && mainRs.includes('settings.mixed_port == settings.controller_port') && mainRs.includes('fn rollback_settings_after_failure'), 'settings port transaction');
