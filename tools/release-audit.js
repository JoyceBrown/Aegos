...
check('manual fixed nodes are editable and persisted', mainRs.includes('manual_nodes') && mainRs.includes('fn save_manual_node') && configPipelineRs.includes('fn apply_manual_nodes') && configPipelineRs.includes('insert_manual_node_into_config') && indexHtml.includes('id="nodeEditorOverlay"') && indexHtml.includes('id="addFixedNodeBtn"') && appJs.includes("invoke('save_manual_node'") && appJs.includes('collectNodeEditorPayload') && interactionSmoke.includes('fixed node editor did not save through backend command'), 'manual fixed nodes');
