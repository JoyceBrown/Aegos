...
check('home recommendation action is compact and non-duplicated', indexHtml.includes('id="switchRecommendedBtn"') && indexHtml.includes('class="recommend-inline"') && indexHtml.includes('id="recommendedNodeName"') && indexHtml.includes('id="recommendedNodeRegion"') && !indexHtml.includes('id="currentNodeName"') && !indexHtml.includes('id="bestNodeList"') && !indexHtml.includes('class="best-node"') && appJs.includes('function renderHomeNodeSummary'), 'compact recommendation action');
...
check('home low-value recommendation metrics are replaced', indexHtml.includes('id="systemProxyMetric"') && indexHtml.includes('id="tunMetric"') && indexHtml.includes('id="adminMetric"') && !indexHtml.includes('id="groupMetric"') && !indexHtml.includes('id="strategyMetric"') && !indexHtml.includes('id="recommendMetric"') && interactionSmoke.includes('duplicate recommended node strip still renders'), 'runtime metrics replace duplicate recommendation metrics');
