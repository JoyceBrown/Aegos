...
check('node row actions are wired and spaced', mainRs.includes('fn test_single_proxy_delay') && appJs.includes("data-node-action=\"connect\"") && appJs.includes("data-node-action=\"test\"") && appJs.includes("data-node-action=\"details\"") && appJs.includes("invoke('test_single_proxy_delay'") && stylesCss.includes('scrollbar-gutter: stable') && stylesCss.includes('104px') && interactionSmoke.includes('node row action buttons did not render'), 'row action buttons');
