...
check('large node lists are windowed and debounced', appJs.includes('nodeRenderLimit = 36') && appJs.includes('homeNodeRenderLimit = 8') && appJs.includes('rowRenderSettleMs = 320') && appJs.includes('visibleNodeRows'), 'windowed node rendering');
