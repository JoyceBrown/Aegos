...
check('home recommendation action is compact and non-duplicated', indexHtml.includes('class="recommend-compact"') && indexHtml.includes('class="recommend-inline"') && indexHtml.includes('id="switchRecommendedBtn"') && indexHtml.includes('class="recommend-switch"') && indexHtml.includes('id="recommendedNodeName"') && stylesCss.includes('grid-template-columns: 58px minmax(132px, 184px)') && stylesCss.includes('min-height: 40px') && !indexHtml.includes('id="recommendedNodeRegion"') && !indexHtml.includes('id="currentNodeName"') && !indexHtml.includes('id="bestNodeList"') && !indexHtml.includes('class="best-node"') && appJs.includes('function renderHomeNodeSummary'), 'compact recommendation action');
