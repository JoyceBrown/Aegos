...
check('system proxy takeover restores previous Windows proxy', coreRuntimeRs.includes('pub struct SystemProxySnapshot') && coreRuntimeRs.includes('pub fn system_proxy_snapshot_points_to_aegos') && coreRuntimeRs.includes('pub fn should_capture_system_proxy_snapshot') && coreRuntimeRs.includes('system_proxy_snapshot_policy_is_owned_by_runtime_boundary') && !mainRs.includes('struct SystemProxySnapshot') && mainRs.includes('capture_proxy_snapshot_before_takeover') && mainRs.includes('write_windows_proxy_snapshot') && mainRs.includes('core_runtime::should_capture_system_proxy_snapshot') && mainRs.includes('shutdown_for_exit') && mainRs.includes('"Windows System Proxy takeover"') && appJs.includes('repairSystemProxyJob') && appJs.includes("runBackgroundJob('repairSystemProxy'") && interactionSmoke.includes('repairSystemProxy'), 'proxy takeover snapshot/repair');
