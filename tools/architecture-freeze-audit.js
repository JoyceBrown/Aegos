...
check('release version has moved to post-freeze cleanup or guarded 3.x line', pkg.version === tauri.version && (/^2\.9\.(?:29|[3-9]\d+)$/.test(pkg.version) || /^3\.(?:0\.0|1\.[0-3])$/.test(pkg.version)), `${pkg.version}/${tauri.version}`);
