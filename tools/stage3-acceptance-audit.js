...
const backendTestStart = mainRs.indexOf('fn test_routing_website');
...
check('3.6.0 stage checkpoint remains documented after later releases', stage3Release.includes('3.6.0') && stage3Release.includes('npm run audit:stage3-acceptance') && !stage3Release.includes('Source-only'), `RELEASE_${stage3Version}.md`);
