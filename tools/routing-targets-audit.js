...
check('frontend displays validation status from structured rule records', renderBody.includes("item.status || 'readonly'") && renderBody.includes('item.target ||') && renderBody.includes('item.note ||'), 'frontend status render');
